...
<body>
    <div class="container">
        ...
        @endif
        <form id="feedForm" action="{{ route('feed.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <small id="captionHelp" class="form-text text-muted">Max 100 characters.</small>
            </div>
            <br>
